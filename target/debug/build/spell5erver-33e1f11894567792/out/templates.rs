...
mod template_search_results_html;
pub use self::template_search_results_html::search_results_html;

#[deprecated(since="0.7.4", note="please use `search_results_html` instead")]
pub use self::search_results_html as search_results;

mod template_spell_card_html;
